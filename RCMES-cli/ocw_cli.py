     ...
     while option != '0':
          ...
          if option == '1':
               ...
               try:
                    ...
                    if new_start_time < fix_min_time or new_start_time > fix_max_time or new_start_time > all_overlap_end_time:
               ...
               try:
                    ...
                    if new_max_time > fix_max_time or new_max_time < fix_min_time or new_max_time < all_overlap_start_time:
                         note = note + " End time has not changed. "
                    else:
                         all_overlap_end_time = new_max_time
          ...
          if option == '5':
               ...
               for each in enumerate(obs_dict):
                    screen.addstr(27 + len(models_dict) + each[0], x/2 + 2, "{0}: {1}".format(each[1], obs_dict[each[1]]['database']))
